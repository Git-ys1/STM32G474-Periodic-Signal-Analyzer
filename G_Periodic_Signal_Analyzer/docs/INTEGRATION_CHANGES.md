...
更新时间：2026-07-30  
新工作区：`projects/g474_full_integration_test`

## 架构决定

本工程以 `projects/teammate_adc_newest` 完整副本为硬件和算法基线，保留
...
`git diff -- projects/teammate_adc_newest projects/tjc_display_demo`为空。
