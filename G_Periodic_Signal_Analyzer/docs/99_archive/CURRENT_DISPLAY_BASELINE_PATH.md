...
> `docs/99_archive/DISPLAY_ARCHITECTURE.md`、`docs/01_architecture/HMI_LAYOUT.md`和
> `docs/01_architecture/HMI_PROTOCOL.md`中的dashboard单页面基线取代。本文仅用于追溯
...
- `docs/99_archive/DISPLAY_BASELINE_FREEZE_2026-07-30.md`
...
- 队友工程：`teammate/archive/adc_reference`，当前未接入且不得随意修改
...
```text
archive/firmware/tjc_display_demo/Core/
├─ Inc/
│  └─ display.h
└─ Src/
   ├─ main.c
